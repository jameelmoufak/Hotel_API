...
namespace Hotel_API.Migrations
{
    ...
    [Migration("20240620044040_seeding")]
            ...
            modelBuilder.Entity("Hotel_API.Models.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CheckOutAt = new DateTime(2024, 6, 20, 7, 40, 40, 124, DateTimeKind.Local).AddTicks(3434),
                            EmployeeId = 1,
                            GuestId = 1,
                            Price = 450.0,
                            RoomId = 1
            ...
            modelBuilder.Entity("Hotel_API.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HotelId = 1,
                            LastName = "AboSamra",
                            StartedDate = new DateTime(2024, 6, 20, 7, 40, 40, 124, DateTimeKind.Local).AddTicks(3154),
            ...
            modelBuilder.Entity("Hotel_API.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookingId = 1,
                            CreatedDate = new DateTime(2024, 6, 20, 7, 40, 40, 124, DateTimeKind.Local).AddTicks(3455),
                            GuestId = 1,
                            TotalAmount = 450.0
                        });
                });
